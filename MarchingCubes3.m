...
while i<totalcubes
    ...
    for j=1:n%Edge1
        if abs(vertex1_y(i)-P(2,j))<cubelength/10
            if abs(vertex1_z(i)-P(3,j))<cubelength/10
    ...
    for j=1:n%Edge2
        if abs(vertex2_x(i)-P(1,j))<cubelength/10
            if abs(vertex2_z(i)-P(3,j))<cubelength/10
    ...
    for j=1:n%Edge3
        if abs(vertex4_y(i)-P(2,j))<cubelength/10
            if abs(vertex4_z(i)-P(3,j))<cubelength/10
    ...
    for j=1:n%Edge4
        if abs(vertex1_x(i)-P(1,j))<cubelength/10
            if abs(vertex1_z(i)-P(3,j))<cubelength/10
    ...
    for j=1:n%Edge6
        if abs(vertex2_y(i)-P(2,j))<cubelength/10
            if abs(vertex2_x(i)-P(1,j))<cubelength/10
    ...
    for j=1:n%Edge7
        if abs(vertex3_y(i)-P(2,j))<cubelength/10
            if abs(vertex3_x(i)-P(1,j))<cubelength/10
    ...
    for j=1:n%Edge8
        if abs(vertex4_y(i)-P(2,j))<cubelength/10
            if abs(vertex4_x(i)-P(1,j))<cubelength/10
    ...
    for j=1:n%Edge9
        if abs(vertex5_y(i)-P(2,j))<cubelength/10
            if abs(vertex5_z(i)-P(3,j))<cubelength/10
    ...
    for j=1:n%Edge10
        if abs(vertex6_x(i)-P(1,j))<cubelength/10
            if abs(vertex6_z(i)-P(3,j))<cubelength/10
    ...
    for j=1:n%Edge11
        if abs(vertex7_y(i)-P(2,j))<cubelength/10
            if abs(vertex7_z(i)-P(3,j))<cubelength/10
    ...
    for j=1:n%Edge12
        if abs(vertex8_x(i)-P(1,j))<cubelength/10
            if abs(vertex8_z(i)-P(3,j))<cubelength/10
